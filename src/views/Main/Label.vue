          ...
          <tbody>
            <tr v-for="item in querySet" :key="item.id">
              ...
              <td
                ...
                v-if="$root.permissions.includes('change_app_label_status')"
              >
                <v-switch
                  value
              ...
              <td
                ...
                v-if="
                  $root.permissions.includes('change_app_label_details') ||
                    $root.permissions.includes('delete_app_label')
                "
              >
                <v-btn
                  class="mr-1"
                  ...
                  v-if="$root.permissions.includes('change_app_label_details')"
                >
  ...
  computed: {
    ...
    cardTitle() {
      return this.isUpdate
        ...
        : `${this.$t("actions.add")} - ${this.$t("nav.labels")}`;
    },
    isUpdate() {
  ...
  methods: {
    ...
    async saveLabel() {
      ...
      if (isValid) {
        ...
        if (this.label.id) {
          this.$http
            .put(`${this.labelsApi}${this.label.id}/`, labelResult)
            .then(
              () => {
                this.snackbar = {
                  color: "success",
